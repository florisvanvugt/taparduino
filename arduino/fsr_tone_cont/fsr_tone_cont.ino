...
Connect the audio jack to digital pin 9 (PWM) through a 1kOhm resistor.
...
void loop(void) {
  ...
  if (fsrReading > threshold){
    ...
    // stop sound from playing again until after the time threshold and FSR reading returns to zero    
